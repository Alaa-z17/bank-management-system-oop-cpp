...
private:
    ...
    static void _SaveCurrencyRecoredToFile(string Recored)
    {
        fstream MyFile;
...
public:
    ...
    float GetExchangeResult(clsCurrency CurrencyTo, float AmountToExchange)
    {
        if (CurrencyCode() == "USD" || CurrencyTo.CurrencyCode() == "USD")
        {
            if (CurrencyCode() != "USD")
                return (AmountToExchange / Rate());
            else
                return (AmountToExchange * CurrencyTo.Rate());
        }
        else
        {
            float DollorTemp = (AmountToExchange / Rate());
            return (DollorTemp * CurrencyTo.Rate());
        }
